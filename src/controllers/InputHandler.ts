...
export class InputHandler {
  ...
  handleKeyDown(event: KeyboardEvent): void {
    ...
    switch (event.key) {
      ...
      case 'PageDown':
        ...
        break;
      case '1':
        this.numkeyFunction('green');
        break;
      case '2':
        this.numkeyFunction('red');
        break;
      case '3':
        this.numkeyFunction('yellow');
        break;
      case '4':
        this.numkeyFunction('blue');
        break;
      case '5':
        this.numkeyFunction('orange');
        break;
      case '6':
        this.numkeyFunction('pink');
        break;
      case '7':
        this.numkeyFunction('cyan');
        break;
      case '8':
        ...
        break;
      case 'w':
        this.engine.controlFontSize(true);
        break;
      case 's':
        this.engine.controlFontSize(false);
        break;
      case 'q':
        this.engine.controlStringSize(true);
        break;
      case 'a':
        this.engine.controlStringSize(false);
        break;
      case 'r':
        this.engine.rapidWordChangeControl();
        break;
      case 'm':
        if (this.engine.ctx) {
  ...
  arrowDirectionControl(newDirection: string, oppositeDirection: string): void {
    if (this.engine.direction != newDirection) {
      if (this.engine.direction === oppositeDirection) {
  ...
  discoControl(): void {
    if (this.ui.isMenuHidden()) {
      this.toggleDisco();
    } else {
      this.toggleDiscoMenu();
    }
  }
